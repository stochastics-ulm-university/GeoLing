...
/**
 * The Euclidean distance for cluster objects having coordinates.
 * 
 * @author Aaron Spettl, Institute of Stochastics, Ulm University
 */
public class EuclideanDistance implements ClusterObjectDistance {
	...
	/**
	 * The Euclidean distance between the coordinates of two objects (or e.g.
